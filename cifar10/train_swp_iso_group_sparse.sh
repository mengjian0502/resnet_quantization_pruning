...
eval_model="./save/resnet20/iso_group_sparsity/ch16/skp_group8_4bit/decay0.0005_lambda0.001_alambda0.01_w4_a4_qsc_grp8_fl8bit_ll8bit/model_best.pth.tar"

for i in $(seq ${lb} ${diff} ${ub})
do
    $PYTHON -W ignore main_iso_group_sparse.py --dataset ${dataset} \
        --data_path ./dataset/   \
        --arch ${model} --save_path ./save/resnet20/iso_group_sparsity/ch${group_ch}/skp_group8_4bit/decay${wd}_lambda${i}_alambda${a_lambda}_w4_a4_qsc_grp8_fl8bit_ll8bit_eval \
