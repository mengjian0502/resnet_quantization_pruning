...
do
    $PYTHON -W ignore main.py --dataset ${dataset} \
        --data_path ./dataset/   \
        --arch ${model} --save_path ./save/resnet20/quant_scheme/zero_skipquant/ch${group_ch}/decay0.0005_lambda${i}_w2_sawb2bit_a2_swpTrue_resumeTrue_zero_skip_fpsc_coef0.05 \
