...
pretrained_model="./save/resnet32/decay0.0002_fullprecision/model_best.pth.tar"

for i in $(seq ${lb} ${diff} ${ub})
do
    $PYTHON -W ignore main.py --dataset ${dataset} \
        --data_path ./dataset/   \
        --arch ${model} --save_path ./save/resnet32/quant_scheme/odd_level_symm/ch${group_ch}/decay0.0005_lambda${i}_w4_a4_swpTrue_resumeTrue_zero_skip_qsc \
