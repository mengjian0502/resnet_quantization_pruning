...
do
    $PYTHON -W ignore main.py --dataset ${dataset} \
        --data_path ./dataset/   \
        --arch ${model} --save_path ./save/resnet20/quant_scheme/even_level_zero_skip_grp_sweep/ch${group_ch}/decay0.0005_lambda${i}_w4_a4_swpTrue_resumeTrue_even_level_zero_skip_qsc_coef0.2 \
